    ...
    public partial class MainScan : System.Web.UI.Page
    {
        ...
        protected void txtQRMain_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SqlConnection connection2 = new SqlConnection(connectionString);
                    SqlCommand sqlCommand3 = new SqlCommand("AddScanQRMainFG", connection2);
                    sqlCommand3.CommandType = CommandType.StoredProcedure;
                    SqlCommand sqlCommand4 = sqlCommand3;
                    connection2.Open();
                    ...
                    switch (int32_2)
                    {
                        ...
                        case 1:
                            ...
                            SqlCommand sqlCommand13 = new SqlCommand("AddInfoSerialFG", connection7);
                            ...
                            SqlCommand sqlCommand15 = new SqlCommand("GetAccumulatedFG", connection8);
                            ...
                            connection8.Close();
                            dataAcumWO.Text = int32_7.ToString();
                            SqlConnection connection9 = new SqlConnection(connectionString);
                            SqlCommand sqlCommand17 = new SqlCommand("GetAccumulatedDayFG", connection9);
                            ...
                            connection9.Close();
                            dataAcumDia.Text = int32_8.ToString();
                            SqlConnection connection10 = new SqlConnection(connectionString);
                            SqlCommand sqlCommand19 = new SqlCommand("GetTotalMainFG", connection10);
                            ...
                            connection10.Close();
                            dataQtyRepair.Text = int32_9.ToString();
                            ...
                            connection11.Close();
                            dataQtyScrap.Text = int32_10.ToString();
                            res.Text = "QR GUARDADO";
